...
class ChatbotModel(nn.Module):
    def __init__(self, input_size, output_size):
        ...
        self.relu=nn.ReLU() #relu is a activation fct 
        self.dropout = nn.Dropout(0.5) #dropout is a regularization technique to prevent overfitting
...
class ChatbotAssistant:
    ...
    @staticmethod
    def tokanize_and_lemmatize(text):
        ...
        if os.path.exists(self.intents_path):
            ...
            for intent in intents_data ['intents']:
                ...
                for pattern in intent['patterns']:
                    pattern_words = self.tokanize_and_lemmatize(pattern)
